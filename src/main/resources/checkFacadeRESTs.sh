...
cp $DIR_NAME/.validatorignore /tmp/yamls
...
java -Dlr.restwatch.rest.spec.path=/tmp -Dlr.restwatch.url=$FACADE_URL -jar swagger-rest-validator.jar $FILTER 2> $REST_VERIFIER_LOG
